...
test_image_path = os.path.join(dir_name, "pedestrian_detection.png")
test_result_path = os.path.join(dir_name, "pedestrian_detection_gt.json")
...
def test_process_sample_pedestrian_detection_adas(reset_ports):
