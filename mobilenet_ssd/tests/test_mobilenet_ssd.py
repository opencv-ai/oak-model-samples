...
from mobilenet_ssd import InferenceModel
...
test_result_path = os.path.join(dir_name, "mobilenet_ssd_gt.json")
...
def test_process_sample_mobilenet_ssd():
    ...
    assert is_equal(ret, test_result, error=0.05)
