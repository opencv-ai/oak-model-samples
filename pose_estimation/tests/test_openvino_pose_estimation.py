...
model_path = os.path.join(
    ...
    "checkpoints",
    "openvino_pose_estimation",
)

data_dir = os.path.join(os.path.dirname(os.path.dirname(dir_name)), "test_data")
test_image_path = os.path.join(data_dir, "openvino_pose_estimation.jpg")
test_result_path = os.path.join(data_dir, "openvino_pose_estimation_gt.json")
...
def test_process_sample_pose_estimation():
    ...
    assert is_equal(ret, test_result, error=0.01)
