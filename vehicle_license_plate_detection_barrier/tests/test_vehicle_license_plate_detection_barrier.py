...
test_result_path = os.path.join(dir_name, "vehicle_license_plate_detection_barrier_gt.json")
...
def test_process_sample_person_detection_retail():
    ...
    assert is_equal(ret, test_result["detection"], error=0.3)
test_process_sample_person_detection_retail()